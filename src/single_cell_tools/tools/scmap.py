...
def common_genes(adata1,adata2,key_genes=None,remove_unmached=False,add_key="Common_genes"):
    """
    ...
    if key_genes != None:
        ...
        data1[add_key] = data1.index.isin(data2.index).values
        data2[add_key] = data2.index.isin(data1.index).values    
